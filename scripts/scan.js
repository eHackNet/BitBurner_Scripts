...
function getServersWithDepth(ns) {
    let result = [];
    let visited = { 'home': 0 };
...
export async function main(ns) {
    ...
    getServersWithDepth(ns).forEach(server => {
        ...
        let hoverText = ["Req Level: ", ns.getServerRequiredHackingLevel(name),
            ...
            "&#10;Money: ", ns.nFormat(ns.getServerMoneyAvailable(name), '0a') + " / " + ns.nFormat(ns.getServerMaxMoney(name), '0a'),
